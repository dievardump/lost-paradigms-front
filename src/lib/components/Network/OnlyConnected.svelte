<script>
	import { chainId, checkedWallet, connected, hasWallet } from '$lib/modules/wallet';
	import { connectWeb3Modal } from '$lib/modules/web3Modal';
	...
	<div class="only-connected">
		...
		{:else}
			<slot name="only-connected">
				...
				<div class="buttons">
					<Button href="https://metamask.app.link/dapp/etherealstates.art">Download MetaMask</Button
					>
				...
				<p class="small">
					...
					<a href="https://github.com/MetaMask/metamask-extension/issues/13622" target="_blank"
						>They can conflict</a
					>.
				</p>
				<div class="buttons">
...
<style lang="postcss">
	.only-connected {
		@apply flex flex-col items-center justify-center py-16 gap-8 text-center;
	}
